#!/usr/bin/env python2
# modified by htm 09/15/14 
# from https://github.com/barbagroup/JITcode-MechE
...
bb_url = 'github.com/htapiagroup/imageproc/blob/master/{}'.format
...
def lesson_name(filename):
    ...
    '''
    [ind.end(0) for ind in re.finditer('Lib[0-9]+',filename)]
